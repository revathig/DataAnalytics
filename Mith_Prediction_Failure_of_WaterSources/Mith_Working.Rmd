...
pred_val = model_predict(basic_model,testdata, threshhold = 0.5)
write.csv(pred_val,file="TestPred.csv")
...
model = ada(x = train_data_wotarget,y = train_data$status,
            iter = 100, loss = "exponential", type="discrete", nu =0.4)
...
write.csv(file = "Mithpredictada1.csv",x= myoutput,row.names = FALSE)
```
